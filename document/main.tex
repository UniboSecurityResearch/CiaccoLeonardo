...
Raccolgo nella Tabella \ref{tab:analisys} le analisi che si possono fare riguardo ai casi presentati, usando l'EBITDA degli anni fiscali degli attacchi per mettere in prospettiva i costi diretti (per le aziende quotate).\\
\newpage
...
\begin{table}[H]
 ...
 milioni di\$ (c.d. / EBITDA )} & \textbf{Perdita di valore percentuale delle azioni}\\
        \hline
