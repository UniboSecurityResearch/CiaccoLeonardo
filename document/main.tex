...
Il \textit{data breach} avvenne ad ottobre 2016, ma la divulgazione risaleva ben un anno dopo, grazie ad un cambio di dirigenza. I rischi che ha corso nel gestire ambiguamente il caso hanno rischiato di avere conseguenze penali\cite{Uber_plusEquifaxAndYahoo}.\\ 
...
Raccolgo in una tabella le analisi che si possono fare riguardo ai casi presentati, usando l'ebitda degli anni fiscali degli attacchi per mettere in rospettiva i costi diretti (per le aziende quotate).
...
\begin{table}
 ...
 milioni di\$ (c.d. / EBITDA )} & \textbf{Costo indiretto}\\
        \hline
        Sony Playstation Network  & 2011 & data breach & 171  (18,8\% \cite{sony_q2_2012_20F}) & -3\% -- -5\% \\
        \hline
         Target & 2013 & data breach & 200  (2,84\% \cite{target_2013_10k}) & -2,2\% \\
         \hline
        Sony Pictures & 2014 & data breach & 49  (1,2\% \cite{SonyPic_20F_report}) & -5\% -- -10\% \\
         \hline
        Yahoo & 2014 & data breach & 152  (12,63\%) & -9,54\% \\
         \hline
         Uber & 2016 & data breach & 148  & -- \\
         \hline
         Uber & 2022 & ingegneria sociale & 0 & -10\% -- -15\% \\
         \hline
         FedEx & 2017 & ransomware (NotPetya) & 400  (5,1\% \cite{chegg_ebitda_fedex_2018}) & -5,03\% \\
         \hline
         Equifax & 2017 & data breach & circa 625  (56,2\% \cite{equifax_2017_10k}) & -8,2\% -- -20\% \\
         \hline
         British Airways & 2018 & data breach via XSS & 20  (0,4\% \cite{iag_2019_report}) & -2\% \\
         \hline
         Marriott International & 2018 & data breach via phisical malware injection & 53  (2\% \cite{marriott_2018_10k}) & -5\% -- -17\% \\
         \hline
         Capital One & 2019 & data breach & 270  (vedere) & -5,89\% -- -12\% \\
         \hline
         SolarWinds & 2020 & supply chain & 26  (5,3\% \cite{solarwinds_2020_10k}) & -34,66\% \\
         \hline
        Colonial Pipeline & 2021 & ransomware & 2,1   & -- \\
         \hline
         MGM Resorts & 2023 & ransomware via vishing & 32,5+  (0,7+\% \cite{mgm_2023_10k}) & \\
         \hline
         Change Healthcare & 2024 & ransomware, data breach & $1\,521$  (4,2\% \cite{unh_2024_10k}) & -5\% -- -10\% \\
         \hline
    \end{tabular}
    \caption{Tabella analisi}
    \label{tab:analisys}
\end{table}

Possiamo notare come le premesse siano state rispettate (-5\% in azioni \cite{accenture2010}), con perdite talvolta particolarmente vistose, e che il mondo della cybersicurezza sta seguendo un trend sempre pi\`u indirizzato agli attacchi \textit{ransomware}.\\
\subsection{note} 
--riformulare--
sony nel 2012 ha un, con cambio del 2012, EBITDA a \$1,154 miliardi

ebitda di sony nel 2014, con cambio vale \$4,032 miliardi

in yahoo non conto il deprezzamento di 350 milioni
