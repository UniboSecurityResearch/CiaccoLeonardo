...
\pagestyle{plain}\addtolength{\headwidth}{20pt}
...
{\normalsize{\it A chi mi sta vicino,\\
chi quotidianamente,\\
chi sporadicamente,\\
...
L'ENISA (Agenzia dell'Unione Europea per la Cybersicurezza) raggruppa gli attacchi informatici in otto categorie principali \cite{enisa_threat_landscape}.
...
\subsection{Descrizione}
A settembre 2016 Yahoo rende noto che nel 2014 sono stati rubati i dati personali di 500 milioni di utenti a seguito di un attacco di ingegneria sociale \cite{yahoo_book}.\\
...
\`E osservabile da Figura \ref{fig:yahoo2} \cite{macrotrends_verizon} che, nel periodo prossimo all'acquisto di Yahoo, Verizon subisce un calo del 6\%. Ulteriori analisi dell'andamento rischiano di essere fuorvianti per via dei diversi componenti dell'azienda al tempo, ma le azioni seguono un trend in crescita.\\
\begin{figure}[H] 
\begin{center} 
...
\subsection{Descrizione}
La holding bancaria Capital One Financial Corporation scopre, tramite una mail proveniente da un esterno di un \textit{data breach} che ha interessato 100 milioni di cittadini statunitensi e 6 milioni canadesi, pubblicando quindi un comunicato al riguardo il 29 luglio 2019 \cite{CapitalOne_case_study}.
\subsection{Impatto diretto}
...
\end{figure}
\subsection{Note}
Sebbene non risulti dalle fonti che siano imputabili a Capital One errori importanti in ambito di sicurezza informatica, 
le ricadute finanziarie sono state consistenti, suggerendo 
l'entit\`a del danno di immagine subito.\\
...
\begin{table}[H]
    ...
    \centering
    \small
    \begin{tabular}{|p{3,5cm}|c|p{4,5cm}|p{4,7cm}|p{2,9cm}|}
        \hline
        \textbf{Nome soggetto colpito} & \textbf{Anno} & \textbf{Tipo di attacco} & \textbf{Costo diretto in mil di \$ (c.d./EBITDA)} & \textbf{Perdita valore delle azioni}\\
        \hline
        ...
        Yahoo & 2014 & data breach & 152  (11,16\% \cite{yahoo_2014_10k}) & 9,54\% \\
         ...
         \hline
         British Airways & 2018 & data breach (XSS) & 26  (0,48\% \cite{iag_2019_report}) & 2\% \\
         \hline
